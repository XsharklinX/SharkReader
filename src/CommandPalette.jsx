...
export default function CommandPalette({
    ...
    const commands = useMemo(() => {
        ...
        list.push(
            ...
            { id: 'open-annotations', icon: '📝', label: 'Buscar en mis anotaciones', hint: 'Sidebar', keywords: 'anotaciones subrayados notas buscar highlights', action: run(() => setSidebarOpen(true)) },
